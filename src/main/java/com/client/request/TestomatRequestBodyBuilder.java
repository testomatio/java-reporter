...
public class TestomatRequestBodyBuilder implements RequestBodyBuilder {
     ...
     */
    @Override
    public String buildCreateTestRunBody(String title) throws JsonProcessingException {
    ...
    public String buildSingleTestReportBody(TestResult result) throws JsonProcessingException {
        ...
        body.put("create", true); // Enable automatic test creation
        return objectMapper.writeValueAsString(body);
    }
    ...
    public String buildBatchTestReportBody(List<TestResult> results, String apiKey) throws JsonProcessingException {
        ...
        requestBody.put(ApiRequestFields.API_KEY, apiKey);
        requestBody.put(ApiRequestFields.TESTS, testsArray);
        requestBody.put("create", true); // Enable automatic test creation
